...
const JS_CHECKS = [
  ...
  { name: "public card official update label", pattern: /"公式更新"/ },
  { name: "public card checked at label", pattern: /"確認日時"/ },
  { name: "public card timestamp helper", pattern: /appendPublicCardTimestampMeta/ },
  { name: "search result timestamp helper", pattern: /appendSearchResultTimestamps/ },
  { name: "search official update fallback", pattern: /確認できません/ },
