...
function main() {
  ...
  [
    ...
    { name: "x cross search promo", pattern: /X_CROSS_SEARCH_PROMO/ },
    { name: "x cross search render init", pattern: /renderDisasterSocialSearch\(page, disasterSocialPayload,\s*\{[\s\S]*evacuationAlertMunicipalities/ },
    { name: "x cross search section title", pattern: /X横断検索/ },
